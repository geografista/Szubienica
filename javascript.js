...
function wypelnijKategorie() {
  ...
  const specjalistyczneDiv = document.getElementById(
...
function sprawdz(nr) {
  ...
  if (haslo == haslo1) {
    document.getElementById("alfabet").innerHTML =
      '<span style="color: green">Tak jest! Podano prawidłowe hasło: </span>' +
      haslo +
      '<br /><br /><span class="reset" onclick="restart()">JESZCZE RAZ?</span>';
    win.play();
  }
  //przegrana
  if (ile_skuch >= 9) {
    document.getElementById("alfabet").innerHTML =
      '<span style="color: red">Przegrana! Nieprawidłowe hasło!<br> </span><br /><br /><span class="reset" onclick="restart()">JESZCZE RAZ?</span>';
    boo.play();
  }
}
